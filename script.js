...
// --- TERRAIN GENERATORS (Make designing specific sections easier) ---

// 1. SHIP TUNNEL: Creates floor and ceiling blocks
function tunnel(start, length, floorH, ceilH) {
    let arr = [];
    for(let i=0; i<length; i++) {
        // Floor stack
        for(let j=0; j<floorH; j++) arr.push({x: start+i, y: j, t: 1});
        // Ceiling stack (Sky is approx y=14)
        for(let k=ceilH; k<16; k++) arr.push({x: start+i, y: k, t: 1});
        // Spikes on floor/ceiling
        arr.push({x: start+i, y: floorH, t: 2}); // Floor spike
        arr.push({x: start+i, y: ceilH-1, t: 2}); // Ceiling spike (pointing down visual handled in draw)
    }
    return arr;
}

// 2. BALL PLATFORM: A floating block with spikes
...
// 3. WAVE CORRIDOR: Very tight space
...
// 4. ROBOT PILLAR: High jump check
...
const LEVELS = [
    ...
    [
        ...
        {x: 85, y: 0, t: 1}, {x: 90, y: 6, t: 2},
        
        {x: 110, y: 0, t: 4}, // CUBE
        {x: 120, y: 2, t: 1}, {x: 130, y: 4, t: 1},
        {x: 150, y: 0, t: 2}
    ],
    ...
    [
        ...
        {x: 70, y: 4, t: 3}, // SHIP
        // Dark Section Tunnel - Up and Down
        ...tunnel(75, 10, 2, 9),
        ...tunnel(90, 10, 5, 12),
        ...tunnel(105, 10, 2, 9),
    ...
    [
        ...
        {x: 50, y: 0, t: 5}, // BALL
        // Platforms with spikes BELOW them requiring you to be on top
        ...platform(60, 4, 3),
        ...platform(75, 7, 3),
        ...platform(90, 4, 3),
    ...
    [
        {x: 10, y: 0, t: 8}, // ROBOT
        // High Pillars
        ...pillar(20, 2), ...pillar(35, 3), ...pillar(50, 5),
        {x: 60, y: 0, t: 2}, {x: 62, y: 0, t: 2},
        
        {x: 80, y: 4, t: 3}, // SHIP
        ...tunnel(85, 30, 3, 9), // Tight middle tunnel
    ...
    [
        ...
        {x: 40, y: 0, t: 5}, // BALL
        // Mirror Mode Sim (Tight platforms)
        ...platform(50, 4, 2), ...platform(60, 4, 2), ...platform(70, 4, 2),
        
        {x: 100, y: 0, t: 8}, // ROBOT
        ...pillar(110, 3), ...pillar(125, 5), ...pillar(140, 6),
    ...
    [
        {x: 10, y: 0, t: 5}, // BALL
        // Floor spikes with high blocks
        {x: 20, y: 0, t: 2}, {x: 25, y: 6, t: 1}, 
        {x: 35, y: 0, t: 2}, {x: 40, y: 6, t: 1},
        
        // Floating platforms
        ...platform(60, 4, 3), ...platform(75, 4, 3), ...platform(90, 4, 3),
        
        {x: 120, y: 3, t: 3}, // SHIP
        ...tunnel(125, 30, 4, 10), // Very tight ship
    ...
    [
        ...
        {x: 30, y: 0, t: 6}, // UFO
        ...pillar(40, 4), ...pillar(50, 4), ...pillar(60, 5),
        
        {x: 80, y: 4, t: 7}, // WAVE
        // Zig Zag Tunnel
        ...wavePath(85, 10, 3, 5), // Gap 5
        ...wavePath(95, 10, 5, 5), // Up
        ...wavePath(105, 10, 2, 5), // Down
        ...wavePath(115, 15, 4, 4), // Tight Gap 4
        
        {x: 150, y: 0, t: 8}, // ROBOT
        ...pillar(160, 3), ...pillar(175, 6),
        
        {x: 200, y: 3, t: 3}, // SHIP END
        ...tunnel(205, 20, 3, 9)
    ]
];
